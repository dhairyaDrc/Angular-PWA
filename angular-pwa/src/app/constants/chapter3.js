export const chapter3 = [
 
  {
    ...
    {
      data:"ADB provides transaction advisory services to assist public and private sector clients structure and procure viable projects. The bank also manages the Asia Pacific Project Preparation Facility (AP3F)—a multi-donor trust fund with contributions from the governments of Australia, Canada, and Japan—to help prepare and monitor PPP projects, build government capacity, and create an enabling environment for PPPs.",
      type:"paragraph"
    },
    {
